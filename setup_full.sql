-- Complete Database Setup Script for Građanski Zahtevi
-- This script will reset the database, create all tables, and add sample data

-- PART 1: RESET DATABASE AND CREATE TABLES
