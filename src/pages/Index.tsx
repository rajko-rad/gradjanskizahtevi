      ...
      <section className="pt-28 pb-16 bg-white text-serbia-blue border-b">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 w-full mt-8">
                  ...
                  {categoryRequests.map((request) => (
                    <div key={request.id} className="flex flex-col h-full">
                      ...
                      <div className="mt-3 flex justify-end">
                        <Button variant="ghost" size="sm" className="text-serbia-blue hover:bg-serbia-blue/10">
                          <FileText className="mr-2 h-4 w-4" />
                          Resursi i više informacija
                        </Button>
                      </div>
                    </div>
                  ))}
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-serbia-blue mb-4">Hronologija zahteva</h2>
